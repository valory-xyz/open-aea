...
``` bash
aea add connection fetchai/stub:0.21.0:bafybeidhuxh6bewogbrnnjk3wejqef4s4qmkybfhxhphqucxwf4djy7fce --remote
```
<br>
...
``` bash
aea add skill fetchai/echo:0.19.0:bafybeihy3asb2z7im3pl4qxg5yqdoxdaveryoxjdosigvrkcoafcggmahi --remote
```
