...
It helps to look at existing contract packages, like `fetchai/erc1155:0.22.0`, and skills using them, like `fetchai/erc1155_client:0.28.0` and `fetchai/erc1155_deploy:0.30.0`, for inspiration and guidance.
