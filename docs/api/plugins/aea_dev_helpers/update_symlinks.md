<a id="plugins.aea-dev-helpers.aea_dev_helpers.update_symlinks"></a>

# plugins.aea-dev-helpers.aea`_`dev`_`helpers.update`_`symlinks

Update symlinks for the project, cross-platform compatible.

<a id="plugins.aea-dev-helpers.aea_dev_helpers.update_symlinks.make_symlink"></a>
...
<a id="plugins.aea-dev-helpers.aea_dev_helpers.update_symlinks.cd"></a>
...
<a id="plugins.aea-dev-helpers.aea_dev_helpers.update_symlinks.create_symlink"></a>
...
<a id="plugins.aea-dev-helpers.aea_dev_helpers.update_symlinks.update_symlinks"></a>
...
- `root_path`: the repository root path. If None, auto-detect.
