...
- Adds support for pytest v8 and updates related tests/utilities. #835
...
Plugins:
- Adds multi-RPC rotation with automatic failover in the Ethereum ledger plugin stack. #829
...
- Updates Click range to `<8.4.0` and applies compatibility fixes for 8.3.x semantics. #838 #839 #848
...
- Reworks ready-awaitable internals to avoid Python 3.14 warnings/regressions and follow-up flaky behavior. #831 #847
...
- Adds follow-up fixes for CLI and framework regressions found after the initial interpreter/dependency bump, including critical audit issues and command behavior corrections. #846 #847 #848
