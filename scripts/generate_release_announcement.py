...
```
Github release
https://github.com/valory-xyz/open-aea/releases/tag/v{version}

Pypi packages
https://pypi.org/project/open-aea/{version}/
https://pypi.org/project/open-aea-cli-ipfs/{version}/
https://pypi.org/project/open-aea-cli-benchmark/{version}/
https://pypi.org/project/open-aea-ledger-ethereum/{version}/
https://pypi.org/project/open-aea-ledger-cosmos/{version}/
https://pypi.org/project/open-aea-ledger-fetchai/{version}/
"""
