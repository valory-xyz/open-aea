...
setup_logger  # unused function (aea/helpers/logging.py:31)  # public helper retained for downstream callers (open-autonomy chain/tx.py, analyse/service.py, plugins/aea-helpers/aea_helpers/bump_dependencies.py)
...
filter_event  # unused method (aea/crypto/base.py:535)
match_single  # unused variable (aea/crypto/base.py:539)
match_any  # unused variable (aea/crypto/base.py:540)
to_block  # unused variable (aea/crypto/base.py:541)
from_block  # unused variable (aea/crypto/base.py:542)
